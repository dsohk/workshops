...
sudo docker build -t myjenkins:v2.0 -f Dockerfile.x86 .
sudo docker tag myjenkins:v2.0 $HARBOR_URL/library/myjenkins:v2.0

# echo "To save time, pull the prebuilt myjenkins docker image ..."
# sudo docker pull susesamples/myjenkins:v2.0
# sudo docker tag susesamples/myjenkins:v2.0 $HARBOR_URL/library/myjenkins:v2.0

# echo "Upload myjenkins image to Harbor private registry ..."
# sudo docker push $HARBOR_URL/library/myjenkins:v2.0
